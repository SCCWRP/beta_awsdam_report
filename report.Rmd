...
```{r, out.width='55%', fig.align='center', fig.cap="Note: This map is a static figure that will be replaced in the next draft of this tool."}
...
# mapview(params$map, legend = FALSE) # adds in map
