...
```{r, out.width='75%', fig.align='center', fig.cap = "Indicator presence/absence denoted in green based on input to tool."}
knitr::include_graphics(
  case_when(params$tbl == 1 ~ here::here("01_H0_AI0_EPT0_ALG0_SI0_EPH-1.png"),
    ...
    params$tbl == 22 ~ here::here("22_H1_AI2_EPT0_ALG1_SIX_ATL-1.png"),
    params$tbl == 23 ~ here::here("23_H1_AI2_EPT1_ALG0_SIX_ATL-1.png"),
...
#   crs = 4326) # use WGS84 projection
 ...
 # mapviewOptions(basemaps = "Esri.WorldImagery") # set output to be topographic map
 # site_map <- mapview::mapview(color = "cyan", site_sf, legend = FALSE) # adds in map
#  
...
```{r, out.width='50%', fig.align='center', fig.cap=params$d}
...
# 
# mapviewOptions(basemaps = "Esri.WorldImagery", # set output to be topographic map
#                layers.control.pos = "topright", # move layers widget
#                homebutton = FALSE) # delete zoom button
# site_map <- mapview::mapview(color = "cyan", site_sf, legend = FALSE) # adds in map
# 
# site_map
#
# mapshot(site_map, file = paste0(tempdir(), "/site_map.png"),
#         remove_controls = c("zoomControl", "homeButton", "layersControl"),
#         selfcontained = FALSE) # exports map as a .png to temporary working directory
# 
# tempReport <- file.path(tempdir(), "site_map.png")
